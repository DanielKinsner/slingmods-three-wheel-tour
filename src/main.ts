...
Object.defineProperty(window, '__tour', {
  get: () => ({
    build: '0.5.1-blender-preview',
    vehicleArt: {
      model: world.cars[0]?.userData.modelId,
      quality: world.cars[0]?.userData.assetQuality,
      suspensionLinks: world.cars[0]?.userData.suspension?.length ?? 0,
    },
    playMode,
